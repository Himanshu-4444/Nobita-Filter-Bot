...
💞 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://telegram.me/visualmovies1'>Clipmate Movies</a></b>
"""
...
<b>➢ ᴄʀᴇᴀᴛᴏʀ ⋟</b>  <a href=https://telegram.me/visualmovies1>Clipmate Movies</a>
...
<b><a href=https://telegram.me/visualmovies1>~ ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ @visualmovies1</a></b>
"""
...
💵 <a href='https://telegram.me/sgrph'>𝗚𝗼𝗼𝗴𝗹𝗲 𝗣𝗮𝘆</a>
💸 <a href='https://telegram.me/sgrph'>𝗣𝗮𝘆𝘁𝗺</a>
💶 <a href='https://telegram.me/sgrph'>𝗣𝗵𝗼𝗻𝗲𝗣𝗲</a>

𝐂𝐨𝐧𝐭𝐚𝐜𝐭 𝐌𝐞 𝐅𝐨𝐫 𝐊𝐧𝐨𝐰 𝐀𝐛𝐨𝐮𝐭 𝐓𝐡𝐞 𝐏𝐚𝐲𝐦𝐞𝐧𝐭 𝐈𝐧𝐟𝐨

<b>ᴄʟɪᴄᴋ ʜᴇʀᴇ - <a href='https://telegram.me/himanshumehta4'>ʙᴏss</a>
ᴄʟɪᴄᴋ ʜᴇʀᴇ - <a href='https://telegram.me/himanshumehta4'>ʙᴏss</a></b>"""
...
if it is not in this then go to @sgrph and type /request movie name our admin will provide it"""
...
<b><a href=https://telegram.me/sgrph>~ ʀᴇǫᴜᴇ𝗌ᴛ ᴛᴏ ᴏᴡɴᴇʀ</a></b>
"""
...
☎️ ʀᴇᴀᴅ ɢʀᴏᴜᴘ ʀᴜʟᴇs ᴛᴏ ᴋɴᴏᴡ ᴍᴏʀᴇ...</b>"""
    ...
    SHORTLINK_INFO = """
<b>──────「 <a href='https://telegram.me/visualmovies1'>ᴇᴀʀɴ ᴍᴏɴᴇʏ</a> 」──────

➥ ɴᴏᴡ ʏᴏᴜ ᴄᴀɴ ᴀʟsᴏ ᴇᴀʀɴ ʟᴏᴛs ᴏꜰ ᴍᴏɴᴇʏ ꜰʀᴏᴍ ᴛʜɪꜱ ʙᴏᴛ.

›› sᴛᴇᴘ 𝟷 : ʏᴏᴜ ᴍᴜsᴛ ʜᴀᴠᴇ ᴀᴛʟᴇᴀsᴛ ᴏɴᴇ ɢʀᴏᴜᴘ ᴡɪᴛʜ ᴍɪɴɪᴍᴜᴍ 44 ᴍᴇᴍʙᴇʀs.

›› sᴛᴇᴘ 𝟸 : ᴍᴀᴋᴇ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ <a href='https://riplinker.in/ref/Educational1'>RIPLINKER</a> ᴏʀ <a href='https://nanolinks.in/ref/Educational1'>NANOLINKS</a>. [ ʏᴏᴜ ᴄᴀɴ ᴀʟsᴏ ᴜsᴇ ᴏᴛʜᴇʀ sʜᴏʀᴛɴᴇʀ ᴡᴇʙsɪᴛᴇ ]
...
☆ if you don't get your movie/webseries there then go to @sgrph and type /request movie name and our admin will add it as soon as possible 

❤️‍🔥 ᴘᴏᴡᴇʀᴇᴅ ʙʏ @visualmovies1
"""
...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    CAPTION = """
[{file_name}](https://telegram.me/visualmovies1)

<b>•────•────────•────•
📌 ʀᴇǫᴜᴇsᴛ ɢʀᴏᴜᴘ​ : [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://telegram.me/sgrph)
🎬 ᴍᴏᴠɪᴇs ᴄʜᴀɴɴᴇʟ​ : [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://telegram.me/visualmovies1)
•────•────────•────•

©️ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : [Clipmate Movies](https://telegram.me/visualmovies1)</b>"""
